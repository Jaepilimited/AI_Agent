...
BASE_STOP: Set[str] = {
    ...
    # 의문·지시
    "뭐", "뭐야", "뭔지", "뭔데", "뭘", "무엇", "무슨", "어디", "어느", "언제",
    "누가", "왜", "어떻게",
    "어떤", "이거", "그거", "저거", "이것", "그것", "관련", "관련된", "대한", "대해",
    # ⚠️ 아래 넷은 2026-09-07 실측에서 **Gmail 검색어로 새던** 말이다.
    #    Gmail 은 낱말을 AND 로 묶어서, 뜻 없는 말이 하나만 남아도 0건이 된다
    #    ("최신메일이 뭐지?" 의 검색어는 `뭐지` 하나뿐이었다).
    #    ⛔ 여기(공용)에 넣는다 — 메일·드라이브·위키가 같은 목록을 봐야 한다.
    "뭐지", "중에서", "포함된", "포함",
    # 너무 일반적인 명사
